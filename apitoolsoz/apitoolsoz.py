...
class ApitoolsOz:
    ...
    @commands.group(pass_context=True, name='apitoolsoz', aliases=['api'])
    async def apitoolsoz(self, ctx):
    ...
    @checks.is_owner()
    @apitoolsoz.command(pass_context=True, name='get')
    ...
    @checks.is_owner()
    @apitoolsoz.command(pass_context=True, name='post', aliases=['put'])
