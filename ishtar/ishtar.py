...
class IshtarAcademy:
    ...
    @commands.command(name="ishtar", pass_context=True)
    @commands.cooldown(5, 60, commands.BucketType.user)
    async def _ishtar(self, ctx, text):
        """Search the databanks of the Ishtar Academy.
        Example: ishtar engram drop rate
        Special search options are available; Image, Images, Maps
        Example: ishtar image Mara Sov tasteful > Returns first image
        Originally made by Kowlin https://github.com/Kowlin/refactored-cogs
        edited by Aioxas and further modified by Fjall for Destiny localization"""
